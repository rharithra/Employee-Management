...
const Attendance = () => {
  ...
  const handleCheckIn = async () => {
    ...
    try {
      ...
      // Update today's attendance with response data
      if (response.data.attendance) {
        setTodayAttendance(response.data.attendance);
      } else {
        // Fallback: refresh by calling checkTodayAttendance
        checkTodayAttendance();
      }
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="flex justify-center gap-4 mt-6">
          <button
            ...
            disabled={checkInLoading || todayAttendance?.checkIn}
          ...
          <button
            ...
            disabled={checkOutLoading || !todayAttendance?.checkIn || todayAttendance?.checkOut}
            className={`px-6 py-3 rounded-lg font-semibold ${
              ...
              {loading ? (
                ...
                Array.isArray(attendance) && attendance.map((record, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {record.workingHours || record.totalHours || 0} hrs
                    </td>
