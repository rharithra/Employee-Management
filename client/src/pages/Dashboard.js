...
import MonthlyPayslipDownload from '../components/MonthlyPayslipDownload';
...
const Dashboard = () => {
  ...
  const [showMonthlyPayslipModal, setShowMonthlyPayslipModal] = useState(false);
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <button
              onClick={() => setShowMonthlyPayslipModal(true)}
              className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors"
            >
              <ArrowDownTrayIcon className="h-8 w-8 text-gray-400 mx-auto mb-2" />
              <p className="text-sm font-medium text-gray-900">Download Monthly Payslips</p>
            </button>
      ...
      {/* Monthly Payslip Download Modal */}
      <MonthlyPayslipDownload
        isOpen={showMonthlyPayslipModal}
        onClose={() => setShowMonthlyPayslipModal(false)}
      />
    </div>
  );
};
