...
const Payroll = () => {
  ...
  const [showMonthlyDownloadModal, setShowMonthlyDownloadModal] = useState(false);
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          {/* Monthly Payslip Download - Available for all users */}
          <button
            onClick={() => setShowMonthlyDownloadModal(true)}
      ...
      <MonthlyPayslipDownload
        isOpen={showMonthlyDownloadModal}
        onClose={() => setShowMonthlyDownloadModal(false)}
      />
    </div>
  );
};
