...
const emailConfig = {
  service: 'gmail',
  auth: {
    user: process.env.EMAIL_USER || 'rharithra9@gmail.com', 
    pass: process.env.EMAIL_PASS || 'oesd oswp rdyo ybro'     
  }
};
...
const testEmailConfig = async () => {
  try {
    ...
    console.log('💡 App will work without email notifications');
    return false; // Continue without email
  }
};
